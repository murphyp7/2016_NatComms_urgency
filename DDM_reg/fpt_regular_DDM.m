...
if gE(1)>gE(2), gE(1)=gE(2); end % deals with one case in which density @ 1st time point was extremely high, and directly followed by a large *negative* value
if gC(1)>gC(2), gC(1)=gC(2); end % think this can happen when eta is very large and fptd is estimated for right-extreme node of drift rate distribution
